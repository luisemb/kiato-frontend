...
var services = (_b = {}, _b[main_1.TIME_PART.dayperiod] = main_2.DayPeriodService, _b[main_1.TIME_PART.hour] = main_2.HoursService, _b[main_1.TIME_PART.minute] = main_2.MinutesService, _b[main_1.TIME_PART.second] = main_2.SecondsService, _b);
/**
 * @hidden
 */
var TimeListVue2 = {
  ...
  created: function created() {
    ...
    this.dom = new main_2.DOMService();
  },
  computed: {
  ...
  methods: {
    ...
    serviceSettings: function serviceSettings(settings) {
      var defaults = {
        ...
        min: (0, kendo_date_math_1.cloneDate)(this.$props.min),
        max: (0, kendo_date_math_1.cloneDate)(this.$props.max),
...
exports.TimeListVue2 = TimeListVue2;
/**
 * @hidden
 */
