...
var TimePickerVue2 = {
  ...
  render: function render(createElement) {
    ...
    var popupClassNames = (0, kendo_vue_common_1.classNames)('k-group k-reset', popupClass);
    ...
    var timePicker = h("div", {
      "class": (0, kendo_vue_common_1.classNames)('k-input', 'k-timepicker', (_a = {}, _a["k-input-".concat(kendo_vue_common_1.kendoThemeMaps.sizeMap[size] || size)] = size, _a["k-input-".concat(fillMode)] = fillMode, _a["k-rounded-".concat(kendo_vue_common_1.kendoThemeMaps.roundedMap[rounded] || rounded)] = rounded, _a['k-invalid'] = !isValid, _a['k-required'] = this.required, _a['k-disabled'] = this.$props.disabled, _a['k-focus'] = this.isFocused, _a)),
      onKeydown: this.handleKeyDown,
      on: this.v3 ? undefined : {
        "keydown": this.handleKeyDown,
  ...
  methods: {
    ...
    mergeTime: function mergeTime(value) {
      return this.computedValue && value ? (0, utils_1.setTime)(this.computedValue, value) : value;
    },
    ...
    handleValueChange: function handleValueChange(event) {
      this.currentValue = (0, kendo_date_math_1.cloneDate)(event.value);
...
exports.TimePickerVue2 = TimePickerVue2;
/**
 * @hidden
 */
