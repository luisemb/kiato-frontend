...
var TimePartVue2 = {
  ...
  created: function created() {
    this.timeLists = [];
    this.snapTime = (0, utils_2.snapTime)((0, utils_2.generateSnappers)(this.$props.steps, this.$props.min));
  ...
  computed: {
    ...
    computedValue: function computedValue() {
      return (0, utils_2.timeInRange)(this.snapTime((0, kendo_date_math_1.cloneDate)(this.$props.value || utils_1.MIDNIGHT_DATE)), this.computedMin, this.computedMax);
    },
    intl: function intl() {
  ...
  render: function render(createElement) {
    ...
    var selectNowMessage = localizationService.toLanguageString(main_1.selectNow, main_1.messages[main_1.selectNow]);
    return h("div", {
      "class": rootClassName
    }, [h("div", {
      "class": "k-time-header"
    ...
    h(kendo_vue_buttons_1.Button, {
      ...
      return [localizationService.toLanguageString(main_1.now, main_1.messages[main_1.now])];
    } : [localizationService.toLanguageString(main_1.now, main_1.messages[main_1.now])])]), h("div", {
  ...
  methods: {
    ...
    showNowButton: function showNowButton() {
      return !this.hasSteps() && this.$props.nowButton && (0, utils_2.isInTimeRange)((0, utils_2.getNow)(), this.computedMin, this.computedMax);
    },
...
exports.TimePartVue2 = TimePartVue2;
/**
 * @hidden
 */
