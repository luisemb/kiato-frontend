...
var ACTIONS = (_a = {},
    ...
    _a[NavigationAction_1.Action.Up] = function (date) { return (0, kendo_date_math_1.addMonths)(date, -4); },
    _a[NavigationAction_1.Action.Right] = function (date) { return (0, kendo_date_math_1.addMonths)(date, 1); },
    _a[NavigationAction_1.Action.Down] = function (date) { return (0, kendo_date_math_1.addMonths)(date, 4); },
...
var YearViewService = /** @class */ (function () {
    ...
    YearViewService.prototype.normalize = function (cellDate, min, max) {
        if (cellDate < min && this.isEqual(cellDate, min)) {
            return (0, kendo_vue_common_1.cloneDate)(min);
        }
        if (cellDate > max && this.isEqual(cellDate, max)) {
            return (0, kendo_vue_common_1.cloneDate)(max);
        }
        return cellDate;
    };
