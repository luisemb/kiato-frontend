...
var ACTIONS = (_a = {},
    ...
    _a[NavigationAction_1.Action.Up] = function (date) { return (0, kendo_date_math_1.addYears)(date, -4); },
    _a[NavigationAction_1.Action.Right] = function (date) { return (0, kendo_date_math_1.addYears)(date, 1); },
    _a[NavigationAction_1.Action.Down] = function (date) { return (0, kendo_date_math_1.addYears)(date, 4); },
...
var DecadeViewService = /** @class */ (function () {
    ...
    DecadeViewService.prototype.datesList = function (start, count) {
        return (0, utils_1.range)(0, count).map(function (i) { return (0, kendo_date_math_1.addDecades)((0, kendo_date_math_1.firstYearOfDecade)(start), i); });
    };
