...
var ROWS_LENGTH = 3;
var ACTIONS = (_a = {},
    _a[main_1.Action.Left] = function (date) { return (0, kendo_date_math_1.addDecades)(date, -1); },
    _a[main_1.Action.Up] = function (date) { return (0, kendo_date_math_1.addDecades)(date, -4); },
    _a[main_1.Action.Right] = function (date) { return (0, kendo_date_math_1.addDecades)(date, 1); },
    _a[main_1.Action.Down] = function (date) { return (0, kendo_date_math_1.addDecades)(date, 4); },
    _a[main_1.Action.PrevView] = function (date) { return (0, kendo_date_math_1.addCenturies)(date, -1); },
    _a[main_1.Action.NextView] = function (date) { return (0, kendo_date_math_1.addCenturies)(date, 1); },
    _a[main_1.Action.FirstInView] = function (date) { return (0, kendo_date_math_1.firstDecadeOfCentury)(date); },
    _a[main_1.Action.LastInView] = function (date) { return (0, kendo_date_math_1.lastDecadeOfCentury)(date); },
    _a);
/**
 * @hidden
 */
var CenturyViewService = /** @class */ (function () {
    ...
    CenturyViewService.prototype.data = function (options) {
        var _this = this;
        var cellUID = options.cellUID, focusedDate = options.focusedDate, isActiveView = options.isActiveView, max = options.max, min = options.min, selectedDate = options.selectedDate, _a = options.selectionRange, selectionRange = _a === void 0 ? main_1.EMPTY_SELECTIONRANGE : _a, viewDate = options.viewDate;
        if (!viewDate) {
            return EMPTY_DATA;
        }
