...
var DateTimeSelectorVue2 = {
  ...
  props: {
    ...
    maxTime: {
      ...
      default: function _default() {
        return (0, kendo_vue_common_1.cloneDate)(utils_1.MAX_TIME);
      }
    },
    minTime: {
      type: Date,
      default: function _default() {
        return (0, kendo_vue_common_1.cloneDate)(utils_1.MIN_TIME);
      }
    },
    weekNumber: {
      type: Boolean,
  ...
  render: function render(createElement) {
    ...
    var dateMessage = localizationService.toLanguageString(main_1.date, main_1.messages[main_1.date]);
  ...
  methods: {
    ...
    normalizeRange: function normalizeRange(candidate, value) {
      return (0, kendo_date_math_1.isEqualDate)(candidate, value || (0, utils_1.getToday)()) ? candidate : null;
    },
    ...
    handleNowClick: function handleNowClick(event) {
      this.timeValue = (0, utils_2.getNow)();
...
exports.DateTimeSelectorVue2 = DateTimeSelectorVue2;
/**
 * @hidden
 */
