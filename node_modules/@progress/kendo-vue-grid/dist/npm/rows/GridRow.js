...
exports.GridRowVue2 = exports.GridRow = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var GridRowVue2 = {
  ...
  render: function render(createElement) {
    ...
    var className = this.$props.rowType === 'groupFooter' || this.$props.rowType === 'groupHeader' ? this.$props.rowType === 'groupFooter' && 'k-group-footer' || 'k-table-group-row k-grouping-row' : (this.$props.isAltRow ? 'k-table-alt-row k-master-row k-alt' : 'k-master-row') + (this.$props.selectedField !== undefined && (0, main_1.getNestedValue)(this.$props.selectedField, this.$props.dataItem) ? ' k-selected' : '');
