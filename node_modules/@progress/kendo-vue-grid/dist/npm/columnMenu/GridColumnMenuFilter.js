...
exports.GridColumnMenuFilterVue2 = exports.GridColumnMenuFilter = exports.filterGroupByField = exports.rootFilterOrDefault = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
    ...
    return (
      ...
      h(GridColumnMenuItemGroup_1.GridColumnMenuItemGroup, this.v3 ? function () {
        ...
        h(GridColumnMenuItemContent_1.GridColumnMenuItemContent, {
          ...
          // @ts-ignore
          !filterUI && [h(GridColumnMenuFilterOperators_1.ColumnMenuFilterOperators, {
          ...
          // @ts-ignore
          h(GridColumnMenuFilterOperators_1.ColumnMenuFilterOperators, {
          ...
          h(kendo_vue_buttons_1.Button, {
            ...
            return [localizationService.toLanguageString(main_1.filterSubmitButton, main_1.messages[main_1.filterSubmitButton])];
          } : [localizationService.toLanguageString(main_1.filterSubmitButton, main_1.messages[main_1.filterSubmitButton])]),
          // @ts-ignore function children
          h(kendo_vue_buttons_1.Button, {
            type: 'reset',
            attrs: _this2.v3 ? undefined : {
            ...
            return [localizationService.toLanguageString(main_1.filterClearButton, main_1.messages[main_1.filterClearButton])];
          } : [localizationService.toLanguageString(main_1.filterClearButton, main_1.messages[main_1.filterClearButton])])])])])])];
        } : [h("div", {
          "class": 'kendo-grid-filter-menu-container'
        }, [h("form", {
          "class": 'k-filter-menu k-group k-reset k-border-up',
          ...
          return [localizationService.toLanguageString(main_1.filterSubmitButton, main_1.messages[main_1.filterSubmitButton])];
        } : [localizationService.toLanguageString(main_1.filterSubmitButton, main_1.messages[main_1.filterSubmitButton])]), h(kendo_vue_buttons_1.Button, {
          type: 'reset',
          attrs: _this2.v3 ? undefined : {
            type: 'reset'
          }
