...
exports.ColumnMenuVue2 = exports.ColumnMenu = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
    ...
    currentOpen: function currentOpen(newOpened) {
      this.$nextTick(function () {
        ...
        if (newOpened && this._content) {
          var focusableElements = kendo_vue_data_tools_1.tableKeyboardNavigationTools.getFocusableElements(this._content, {
            focusable: true
          });
...
exports.ColumnMenuVue2 = ColumnMenuVue2;
/**
 * @hidden
 */
