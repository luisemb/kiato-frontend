...
exports.SwitchVue2 = exports.Switch = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var SwitchVue2 = {
  ...
  created: function created() {
    ...
    this._id = (0, kendo_vue_common_1.guid)();
    this.defaultValidationMessage = (0, kendo_vue_intl_1.provideLocalizationService)(this);
  },
  data: function data() {
    return {
  ...
  computed: {
    ...
    switchClassName: function switchClassName() {
      ...
      return _a = {
        'k-switch': true
      }, _a["k-switch-".concat(kendo_vue_common_1.kendoThemeMaps.sizeMap[this.$props.size])] = this.$props.size, _a["k-rounded-".concat(kendo_vue_common_1.kendoThemeMaps.roundedMap[rounded] || rounded)] = rounded, _a['k-switch-on'] = this.computedValue, _a['k-switch-off'] = !this.computedValue, _a['k-focus'] = this.focused, _a['k-disabled'] = this.$props.disabled, _a['k-invalid'] = !isValid, _a;
    },
    switchTrackClass: function switchTrackClass() {
      ...
      return _a = {
        'k-switch-track': true
      }, _a["k-rounded-".concat(kendo_vue_common_1.kendoThemeMaps.roundedMap[rounded] || rounded)] = rounded, _a;
    },
  ...
  mounted: function mounted() {
    this._element = (0, kendo_vue_common_1.getRef)(this, 'element');
  ...
  methods: {
    ...
    setValidity: function setValidity() {
      if (this.input && this.input.setCustomValidity) {
        this.input.setCustomValidity(this.validity().valid ? '' : this.$props.validationMessage || this.defaultValidationMessage.toLanguageString(main_1.switchValidation, main_1.messages[main_1.switchValidation]));
      }
    },
