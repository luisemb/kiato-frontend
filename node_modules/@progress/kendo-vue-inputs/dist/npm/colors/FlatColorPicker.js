...
var FlatColorPickerVue2 = {
  ...
  render: function render(createElement) {
    ...
    var paletteMessage = localizationService.toLanguageString(main_1.flatColorPickerPaletteBtn, main_1.messages[main_1.flatColorPickerPaletteBtn]);
    var clearMessage = localizationService.toLanguageString(main_1.flatColorPickerClearBtn, main_1.messages[main_1.flatColorPickerClearBtn]);
    var cancelMessage = localizationService.toLanguageString(main_1.flatColorPickerCancelBtn, main_1.messages[main_1.flatColorPickerCancelBtn]);
    var applyMessage = localizationService.toLanguageString(main_1.flatColorPickerApplyBtn, main_1.messages[main_1.flatColorPickerApplyBtn]);
    ...
    var renderGradiente = function renderGradiente() {
      return h(ColorGradient_1.ColorGradient, __assign({
        ...
        ref: (0, kendo_vue_common_1.setRef)(this, 'gradient'),
        tabIndex: -1,
        value: this.colorValue,
        innerTabIndex: this.computedTabIndex,
    ...
    var renderPalette = function renderPalette() {
      return h(ColorPalette_1.ColorPalette, __assign({
        ...
        ref: (0, kendo_vue_common_1.setRef)(this, 'palette'),
    ...
    return h("div", {
      ...
      "class": (0, kendo_vue_common_1.classNames)('k-flatcolorpicker k-coloreditor', {
