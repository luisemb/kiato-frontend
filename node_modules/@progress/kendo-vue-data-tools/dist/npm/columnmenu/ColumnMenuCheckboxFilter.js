...
exports.ColumnMenuCheckboxFilterVue2 = exports.ColumnMenuCheckboxFilter = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var ColumnMenuCheckboxFilterVue2 = {
  ...
  updated: function updated() {
    ...
    var data = this.$props.dataItems.map(function (item) {
      return (0, kendo_vue_common_1.getNestedValue)(field, item);
    });
  ...
  render: function render(createElement) {
    ...
    h(kendo_vue_inputs_1.Checkbox, {
      label: localizationService.toLanguageString(main_1.filterCheckAll, main_1.messages[main_1.filterCheckAll]),
      attrs: this.v3 ? undefined : {
        label: localizationService.toLanguageString(main_1.filterCheckAll, main_1.messages[main_1.filterCheckAll]),
  ...
  methods: {
    defaultFilter: function defaultFilter() {
      if (this.$props.filter) {
        return (0, kendo_vue_common_1.clone)(this.$props.filter);
      }
      return {
        filters: [],
        logic: 'and'
    ...
    handleSearchChange: function handleSearchChange(e) {
      ...
      this.currentData = this.parseData((0, kendo_data_query_1.filterBy)(this.$props.dataItems || [], filterExpression), this.$props.uniqueData);
    },
...
exports.ColumnMenuCheckboxFilterVue2 = ColumnMenuCheckboxFilterVue2;
/**
 * @hidden
 */
var ColumnMenuCheckboxFilter = ColumnMenuCheckboxFilterVue2;
exports.ColumnMenuCheckboxFilter = ColumnMenuCheckboxFilter;