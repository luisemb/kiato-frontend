...
var textOperators = [
    { text: main_1.filterContainsOperator, operator: 'contains' },
    { text: main_1.filterNotContainsOperator, operator: 'doesnotcontain' },
    { text: main_1.filterEqOperator, operator: 'eq' },
    { text: main_1.filterNotEqOperator, operator: 'neq' },
    { text: main_1.filterStartsWithOperator, operator: 'startswith' },
    { text: main_1.filterEndsWithOperator, operator: 'endswith' },
    { text: main_1.filterIsNullOperator, operator: 'isnull' },
    { text: main_1.filterIsNotNullOperator, operator: 'isnotnull' },
    { text: main_1.filterIsEmptyOperator, operator: 'isempty' },
    { text: main_1.filterIsNotEmptyOperator, operator: 'isnotempty' }
];
var numericOperators = [
    { text: main_1.filterEqOperator, operator: 'eq' },
    { text: main_1.filterNotEqOperator, operator: 'neq' },
    { text: main_1.filterGteOperator, operator: 'gte' },
    { text: main_1.filterGtOperator, operator: 'gt' },
    { text: main_1.filterLteOperator, operator: 'lte' },
    { text: main_1.filterLtOperator, operator: 'lt' },
    { text: main_1.filterIsNullOperator, operator: 'isnull' },
    { text: main_1.filterIsNotNullOperator, operator: 'isnotnull' }
];
var dateOperators = [
    { text: main_1.filterEqOperator, operator: 'eq' },
    { text: main_1.filterNotEqOperator, operator: 'neq' },
    { text: main_1.filterAfterOrEqualOperator, operator: 'gte' },
    { text: main_1.filterAfterOperator, operator: 'gt' },
    { text: main_1.filterBeforeOperator, operator: 'lt' },
    { text: main_1.filterBeforeOrEqualOperator, operator: 'lte' },
    { text: main_1.filterIsNullOperator, operator: 'isnull' },
    { text: main_1.filterIsNotNullOperator, operator: 'isnotnull' }
];
