                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-2 col-sm-4 col">
                          <div class="text-center">
                            <div
                              class="
                                border border-success border-top-0
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
                        ...
                        <div class="col-xl-2 col-sm-4 col">
                          <div class="text-center">
                            <div
                              class="
                                border border-success border-end-0
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
                        ...
                        <div class="col-xl-2 col-sm-4 col">
                          <div class="text-center">
                            <div
                              class="
                                border border-success border-bottom-0
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
                    ...
                    <div>
                      ...
                      <div class="d-flex align-items-start flex-wrap gap-4">
                        ...
                        <div class="text-center">
                          <div
                            class="
                              border border-success border-groove
                              avatar-md
                              bg-light
                              mx-auto
                              mb-1
                        ...
                        <div class="text-center">
                          <div
                            class="
                              border border-info border-outset
                              avatar-md
                              bg-light
                              mx-auto
                              mb-1
                        ...
                        <div class="text-center">
                          <div
                            class="
                              border border-warning border-ridge
                              avatar-md
                              bg-light
                              mx-auto
                              mb-1
                        ...
                        <div class="text-center">
                          <div
                            class="
                              border border-danger border-inset
                              avatar-md
                              bg-light
                              mx-auto
                              mb-1
                      ...
                      <div class="row">
                        <div class="col-sm-3 col-">
                          <div class="text-center">
                            <div
                              class="
                                border-start border-start-dashed border-success
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
                        ...
                        <div class="col-sm-3 col-">
                          <div class="text-center">
                            <div
                              class="
                                border-top border-top-dashed border-success
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
                        ...
                        <div class="col-sm-3 col-">
                          <div class="text-center">
                            <div
                              class="
                                border-end border-end-dashed border-success
                                avatar-md
                                bg-light
                                mx-auto
                                mb-1
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              Use below-mentioned class to an element to display the value of
            ...
            <div class="live-preview">
              ...
              <div class="mt-4">
                ...
                <p class="text-muted">
                  Change the display value of elements when printing with our
                  print display utility classes.
                </p>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              Use the below-mentioned class to an element to custom display the
              value of components and more with our display utilities.
            </p>
            <div class="live-preview">
              <div>
                <div class="table-responsive">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted mb-3">
              Use
              <code>vstack</code> class to create vertical layouts. Stacked
              items are full-width by default. Use <code>gap-</code> class with
              variation to add space between items.
            </p>
            <div class="live-preview">
      ...
      <div class="col-xxl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted mb-3">
              Use
              <code>hstack</code> class to create horizontal layouts. Stacked
              items are full-width by default. Use <code>gap-</code> class with
              variation to add space between items.
            </p>
            ...
            <div class="live-preview">
              ...
              <div class="mt-4">
                ...
                <div class="hstack gap-3">
                  <div class="bg-light border p-1 px-2">First item</div>
                  <div class="bg-light border p-1 px-2 ms-auto">
                    Second item
                  </div>
                  <div class="bg-light border p-1 px-2">Third item</div>
                </div>
      ...
      <div class="col-xxl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted mb-3">
              Use
              <code>user-select-all</code>, <code>user-select-auto</code>, or
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="live-preview">
              <div>
                <p>
                  <a href="#" class="text-success pe-none" tabindex="-1"
                    >This link</a
                  >
                  can not be clicked.
                </p>
                <p>
                  <a href="#" class="text-success pe-auto">This link</a> can be
                  clicked (this is default behavior).
                </p>
                <p class="pe-none mb-0">
                  <a href="#" class="text-success" tabindex="-1">This link</a>
                  can not be clicked because the
                  <code>pointer-events</code> property is inherited from its
                  parent. However, <a href="#" class="pe-auto">this link</a> has
                  a <code>pe-auto</code> class and can be clicked.
                </p>
              </div>
            </div>
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="overflow-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
                    ...
                    <div class="mt-4 mt-xl-0">
                      ...
                      <div class="d-md-flex bg-light">
                        ...
                        >
                          ...
                          will vertically scroll. Lorem ipsum dolor sit amet,
                    ...
                    <div class="mt-4 mt-xl-0">
                      ...
                      <div class="d-md-flex bg-light">
                        ...
                        >
                          ...
                          width and height dimensions. Lorem ipsum dolor sit
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="position-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use below mentioned classes to arrange elements easily with the
              edge positioning utilities.The format is {property}-{position}.
            </p>
            <div class="live-preview">
              <div>
                <div class="row">
        ...
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="shadow-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              shadow with our <code>box-shadow</code> utility classes. Includes
              support for <code>.shadow-none</code> and three default sizes
        ...
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="width-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              <code>w-100</code> or <code>w-auto</code> class to set width
        ...
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="height-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              <code>h-100</code> or <code>h-auto</code> class to set height
              <code>25%</code>, <code>50%</code>, <code>75%</code>,
              <code>100%</code>, or <code>auto</code> by default respectively.
            </p>
            <div class="live-preview">
