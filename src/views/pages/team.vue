          ...
          <div class="col-sm-auto ms-auto">
            <div class="list-grid-nav hstack gap-1">
              ...
              <button
                type="button"
                id="list-view-button"
                class="btn btn-soft-primary nav-link btn-icon fs-14 filter-button"
              >
              ...
              <div class="p-3 border-top">
                ...
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">
                      <a href="javascript:void(0);" class="link-secondary">Images</a>
                    </h6>
                ...
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">
                      <a href="javascript:void(0);" class="link-secondary">Documents</a>
                    </h6>
                ...
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">
                      <a href="javascript:void(0);" class="link-secondary">Media</a>
                    </h6>
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">
                      <a href="javascript:void(0);" class="link-secondary">Others</a>
                    </h6>
