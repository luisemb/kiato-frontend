            ...
            item.addEventListener("click", function () {
                ...
                conversationImg.querySelectorAll(".left .chat-avatar").forEach(function (item) {
                    if (userProfile) {
                        ...
                        item.querySelector("img").setAttribute("src", '@/assets/images/users/avatar-2.jpg');
                    }
                });
            });
        });
        ...
        <div class="email-menu-sidebar" id="menusidebar">
            <div class="p-4 d-flex flex-column h-100">
                <div class="pb-4 border-bottom border-bottom-dashed">
                    <button type="button" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#composemodal"><plus-circle-icon class="icon-xs me-1 icon-dual-light"></plus-circle-icon> Compose</button>
                </div>

                <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                    <div class="mail-list mt-3">
                        <a href="#" class="active" @click="changemenu('all')"><i class="ri-mail-fill me-3 align-middle fw-medium"></i> <span class="mail-list-link">All</span> <span class="badge badge-soft-success ms-auto  ">5</span></a>
                        <a href="#" @click="changemenu('Inbox')"><i class="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> Inbox <span class="badge badge-soft-success ms-auto  ">5</span></a>
                        <a href="#" @click="changemenu('Sent')"><i class="ri-send-plane-2-fill me-3 align-middle fw-medium"></i> Sent</a>
                        <a href="#" @click="changemenu('Draft')"><i class="ri-edit-2-fill me-3 align-middle fw-medium"></i>Draft</a>
                        <a href="#" @click="changemenu('Spam')"><i class="ri-error-warning-fill me-3 align-middle fw-medium"></i>Spam</a>
                        <a href="#" @click="changemenu('Trash')"><i class="ri-delete-bin-5-fill me-3 align-middle fw-medium"></i>Trash</a>
                        <a href="#" @click="changemenu('Starred')"><i class="ri-star-fill me-3 align-middle fw-medium"></i>Starred</a>
                        <a href="#" @click="changemenu('Important')"><i class="ri-price-tag-3-fill me-3 align-middle fw-medium"></i>Important</a>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mail-list mt-1">
                            <a href="#" @click="changelable('Support')"><span class="ri-checkbox-blank-circle-line me-2 text-info"></span> Theme Support <span class="badge badge-soft-success ms-auto">3</span></a>
                            <a href="#" @click="changelable('Freelance')"><span class="ri-checkbox-blank-circle-line me-2 text-warning"></span> Freelance</a>
                            <a href="#" @click="changelable('Social')"><span class="ri-checkbox-blank-circle-line me-2 text-primary"></span> Social</a>
                            <a href="#" @click="changelable('Friends')"><span class="ri-checkbox-blank-circle-line me-2 text-danger"></span> Friends<span class="badge badge-soft-success ms-auto">2</span></a>
                            <a href="#" @click="changelable('Family')"><span class="ri-checkbox-blank-circle-line me-2 text-success"></span> Family</a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-n2 mb-3 mb-sm-0">
                        ...
                        <div class="col-sm order-3 order-sm-2">
                            <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                ...
                                <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm fs-16" data-bs-toggle="modal" data-bs-target="#removeItemModal" data-bs-trigger="hover" data-bs-placement="top" title="Trash">
                                    <i class="ri-delete-bin-5-fill align-bottom"></i>
                                </button>
                                </div>
                                <div class="vr align-self-center mx-2"></div>
                                <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm fs-16" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Labels">
                            ...
                            <li :class="{'unread':data.readed==false}" v-if="menutab=='all' || data.tabtype==menutab || labeltype=='all' || data.labeltype==labeltype">
                                <div>
                                    <div class="col-mail col-mail-1">
                                        ...
                                        <button type="button" class="btn avatar-xs p-0 favourite-btn fs-15" :class="{'active': data.starred==true}" @click="toggleFavourite">
                                            <i class="ri-star-fill"></i>
                                        </button>
                                        <a href="javascript: void(0);"  @click="openemail" class="title-name">{{data.name}}</a>
                                    </div>
                                    <div class="col-mail col-mail-2" @click="openemail">   
                                        <a href="javascript: void(0);" class="subject"> <span class="subject-title">{{data.title}}</span> – <span class="teaser">{{data.description}}</span>
                                        </a>
        ...
        <div class="card mb-0">
            ...
            <div class="card-body p-0">
                <div id="users-chat">
                    ...
                    </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 479px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 130px; display: block; transform: translate3d(0px, 120px, 0px);"></div></div></div>
                </div>
