...
export default {
  ...
  methods: {
    ...
    editdata(data){
      ...
      document.getElementById('edtorderId').value=this.orders[result].orderId;
    ...
    updateorder(){
        let result =   this.orders.findIndex(o => o.orderId == document.getElementById('edtorderId').value)
    ...
    {statuscolor='danger'}
    if(orderId!=null && customername!=null && productname!=null && orderdate!=null && amount!=null && payment!=null  && delivered!=null)
    {
    var data=  {
          id: 'x',
          orderId: "#VZ2"+orderId,
          ...
          <div class="card-header border-0">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                ...
                <button type="button" class="btn btn-soft-success ms-1">
              ...
              >
                ...
                <li class="nav-item">
                  ...
                  >
                    ...
                    <span class="badge bg-secondary align-middle ms-1">2</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a
