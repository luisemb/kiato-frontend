      ...
      <div class="col-xl-3 col-lg-6" v-for="(item, index) of sellersList" :key="index">
        <div class="card ribbon-box right overflow-hidden">
          <div class="card-body text-center p-4">
            <div class="ribbon ribbon-primary ribbon-shape trending-ribbon" v-if="item.isTrending == true">
            ...
            <h5 class="mb-1 mt-4">
              <router-link to="/ecommerce/seller-details" class="link-secondary"
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-content border-0 mt-3">
            <ul
              class="nav nav-tabs nav-tabs-custom nav-primary p-2 pb-0 bg-light"
              role="tablist"
            >
              <li class="nav-item">
                <a
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="hstack gap-2 justify-content-end">
                        <button
                          class="btn btn-link link-primary text-decoration-none fw-medium"
                          data-bs-dismiss="modal"
                        >
