...
export default {
  ...
  methods: {
    ...
    updatedata() {
      let result = this.customerList.findIndex(
        (o) => o.customerId == document.getElementById("edtidfield1").value
      );
      this.customerList[result].customer =
        document.getElementById("edtcustomername").value;
      this.customerList[result].email =
            ...
            <div class="row g-4 align-items-center">
              ...
              <div class="col-sm-auto">
                <div>
                  ...
                  <button type="button" class="btn btn-primary add-btn me-1" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal">
                      ...
                      <td>
                        <ul class="list-inline hstack gap-2 mb-0">
                          <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                            <a href="#editmodal" data-bs-toggle="modal" class="text-primary d-inline-block edit-item-btn" @click="editdata(item)" >
        ...
        <form action="#" id="addform">
          ...
          <div class="modal-footer">
            <div class="hstack gap-2 justify-content-end">
              <button type="button" id="closemodal" class="btn btn-light" data-bs-dismiss="modal">Close</button>
