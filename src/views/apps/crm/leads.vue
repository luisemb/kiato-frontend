...
export default {
  ...
  methods: {
    ...
    updateorder(){
        let result = this.leads.findIndex(o => o.id == document.getElementById('id').value)
            ...
            <div class="row g-4 align-items-center">
              ...
              <div class="col-sm-auto ms-auto">
                <div class="hstack gap-2">
                  ...
                  <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasExample">
                    <i class="ri-filter-3-line align-bottom me-1"></i> Fliters
                  </button>
                  <button type="button" class="btn btn-soft-success add-btn" id="create-btn" data-bs-toggle="modal" href="#showModal" @click="addnew"> 
                    ...
                    <tr v-for="(data, index) of resultQuery" :key="index">
                      ...
                      <td>
                        <ul class="list-inline hstack gap-2 mb-0">
                          ...
                          <li class="list-inline-item" data-bs-toggle="modal" href="#showModal" data-bs-trigger="hover" data-bs-placement="top" title="Edit" @click="editdata(data)">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <input type="email" id="companyname" class="form-control" placeholder="Enter company name" required />
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-lg-6">
