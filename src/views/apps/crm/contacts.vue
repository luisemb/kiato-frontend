...
export default {
  ...
  methods: {
    ...
    editdata(data){
      ...
      document.getElementById('leadscore').value=this.contactsList[result].score;
      document.getElementById('date').value=this.contactsList[result].date[0];
      document.getElementById('edit-btn').style.display='block';
      document.getElementById('add-btn').style.display='none'
    },
    updateorder(){
        let result =   this.contactsList.findIndex(o => o.id == document.getElementById('id').value)
        ...
        this.contactsList[result].score=document.getElementById('leadscore').value;
        this.contactsList[result].date[0]=document.getElementById('date').value;
    ...
    addorder(){
      ...
      if(id!=null && contactname!=null && companyname!=null && emailid!=null && phone!=null && leadscore!=null  && date!=null)
      {
      var data= {
          id: id,
          contactId: "#VZ001",
              ...
              <div class="col-md-auto ms-auto">
                <div class="d-flex align-items-center gap-2">
                  <span class="text-muted flex-shrink-0">Sort by: </span>
                   <Multiselect class="form-control" style="width:120px;"
                          v-model="value"
                          ...
                          <li class="list-inline-item">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                  <a class="dropdown-item" href="javascript:void(0);"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                    View</a>
                                </li>
                                <li>
                                  <a class="dropdown-item edit-item-btn" data-bs-toggle="modal" href="#showmodal" @click="editdata(data)">
