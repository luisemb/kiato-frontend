...
export default {
  ...
  methods: {
    editdata(data){
        ...
        let result = this.companies.findIndex(o => o.id == data.id)
    ...
    updateorder(){
        let result = this.companies.findIndex(o => o.id == document.getElementById('id').value)
    ...
    if(name!=null && owner!=null && industry_type!=null && star_value!=null && location!=null && employee!=null  && website!=null && contact_email!=null && since!=null)
    {
    var data=  {
        id : id,
        name : name,
              ...
              <table class="table table-borderless mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="javascript:void(0);" class="link-primary text-decoration-underline" id="webs">www.syntycesolution.com</a>
                    </td>
                  </tr>
                  <tr>
