  ...
  methods: {
    ...
    deleteclient(ID) {
      ...
      swalWithBootstrapButtons
          .fire({
            title: "Are you sure?",
            text: "This prospect will be recover and send to the prospects list.",
            icon: "warning",
