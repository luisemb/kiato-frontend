          ...
          <div class="card-header">
            <div class="d-flex mb-3">
              ...
              <div class="flex-shrink-0">
                <a href="#" class="text-decoration-underline link-secondary">Clear All</a>
              </div>
            </div>
                            ...
                            <span>
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li>
                                    <router-link class="dropdown-item" to="/ecommerce/product-details"><i class="
                                          ri-eye-fill
                                          align-bottom
                                          me-2
                                          text-muted
                                  ...
                                  <li>
                                    <router-link class="dropdown-item" to="/ecommerce/add-product"><i class="
                                          ri-pencil-fill
                                          align-bottom
                                          me-2
                                          text-muted
