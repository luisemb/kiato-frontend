            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <h5 class="text-success fs-14 mb-0">
                  <i class="ri-arrow-right-up-line fs-12 align-middle"></i>
                  +16.24 %
                </h5>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <h5 class="text-warning fs-14 mb-0">
                  <i class="ri-arrow-right-down-line fs-12 align-middle"></i>
                  -3.57 %
                </h5>
              </div>
            </div>
          ...
          <div class="card-body p-0">
            <div class="row row-cols-md-3 row-cols-1">
              ...
              <div class="col col-lg">
                <div class="mt-3 mt-lg-0 py-4 px-3">
                  <h5 class="text-muted text-uppercase fs-12">
                    Annual Deals
                    <i class="
                        ri-arrow-down-circle-line
                        text-danger
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded-circle fs-2">
                    <ExternalLinkIcon class="text-primary"></ExternalLinkIcon>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <span class="badge badge-soft-light fs-12"><i
                    class="ri-arrow-up-s-line fs-12 align-middle me-1"></i>6.11 %<span> </span></span>
              </div>
            </div>
          </div>
          <!-- end card body -->
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <span class="badge badge-soft-danger fs-12"><i
                    class="ri-arrow-down-s-line fs-12 align-middle me-1"></i>10.35 %<span> </span></span>
              </div>
            </div>
          </div>
          <!-- end card body -->
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <span class="badge badge-soft-success fs-12"><i
                    class="ri-arrow-up-s-line fs-12 align-middle me-1"></i>22.96 %<span> </span></span>
              </div>
            </div>
          </div>
          <!-- end card body -->
        ...
        <div class="card card-height-100">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <span class="badge badge-soft-success fs-12"><i
                    class="ri-arrow-up-s-line fs-12 align-middle me-1"></i>16.31 %<span> </span></span>
              </div>
            </div>
          </div>
          <!-- end card body -->
        ...
        <div class="card">
          <div class="card-body p-0">
            <div class="
                ...
                align-items-center
              " role="alert">
              <alert-triangle-icon class="text-info me-2 icon-sm"></alert-triangle-icon>
        ...
        <div class="card bg-primary">
          <div class="card-body p-0">
            ...
            <div class="row align-items-end">
              <div class="col-sm-8">
                <div class="p-3">
                  <p class="fs-15 lh-base text-white">
                    Upgrade your plan from a
                    <span class="fw-semibold">Free trial</span>, to ‘Premium
                    Plan’ <i class="mdi mdi-arrow-right"></i>
                  </p>
      ...
      <div class="col-xxl-4">
        <div class="card card-height-100">
          ...
          <div class="card-header p-0">
            <div class="
                alert alert-primary alert-solid alert-label-icon
                border-0
                rounded-0
                m-0
                d-flex
