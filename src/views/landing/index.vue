        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <router-link to="/auth/signin-basic" class="btn btn-link fw-medium text-decoration-none text-dark">Sign
                            in</router-link>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                ...
                                <router-link to="/pages/pricing" class="btn btn-danger">View Plans <i class="ri-eye-line align-middle ms-1"></i></router-link>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row text-center gy-4">
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><count-to :startVal='0' :endVal='100' :duration='5000'>0</count-to>+</h2>
                    ...
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><count-to :startVal='0' :endVal='24' :duration='5000'>0</count-to></h2>
                    ...
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><count-to :startVal='0' :endVal='20' :duration='5000'>0</count-to>k</h2>
                    ...
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><count-to :startVal='0' :endVal='50' :duration='5000'>0</count-to></h2>
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><router-link to="/pages/profile">About US</router-link></li>
                                        <li><router-link to="">Gallery</router-link></li>
                                        <li><router-link to="/apps/projects-list">Projects</router-link></li>
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        ...
                                        <li><router-link to="/mailbox">Mailbox</router-link></li>
                                        <li><router-link to="/chat">Chat</router-link></li>
                                        <li><router-link to="/apps/crm-deals">Deals</router-link></li>
                                        <li><router-link to="/apps/tasks-kanban">kanban board</router-link></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><router-link to="/pages/faqs">FAQ's</router-link></li>
                                        <li><router-link to="/pages/faqs">Contacts</router-link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
