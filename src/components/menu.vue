...
import {HomeIcon, UsersIcon, CodepenIcon, WifiIcon, TrelloIcon, BriefcaseIcon, CalendarIcon, InfoIcon} from "@zhuowenli/vue-feather-icons";
import jwt_decode from "jwt-decode";

export default {
  components: { SimpleBar,HomeIcon,UsersIcon,CodepenIcon,WifiIcon,TrelloIcon, BriefcaseIcon, CalendarIcon, InfoIcon},
  data() {
    return {
      settings: {
  ...
  <div class="container-fluid">
    ...
    <template v-else>
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="menu-title" v-if="viewPermission('CALENDAR')">
          <i class="ri-more-fill"></i>
          <span data-key="t-agent-tab">{{ $t("t-calendar") }}</span>
        </li>
        <li class="nav-item">
          <router-link
              :to="{name: 'calendar'}"
        ...
        <li class="nav-item" v-if="viewPermission('AGENTLIST')">
          <router-link
              :to="{name: 'agentsAppoinments'}"
              data-key="t-calendar-agents-appoinment"
              class="nav-link menu-link"
          >
            <CalendarIcon></CalendarIcon>
        ...
        <li class="menu-title" v-if="viewPermission('AGENTLIST')">
          <i class="ri-more-fill"></i>
          <span data-key="t-agent-tab">{{ $t("t-agent-tab") }}</span>
        </li>
        <li class="nav-item" v-if="viewPermission('AGENTLIST')">
          <a
            class="nav-link menu-link"
          ...
          <div class="collapse menu-dropdown" id="sidebarApps">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <router-link
                    :to="{name: 'agentListKanban'}"
                    class="nav-link"
                    data-key="t-agent-list-kanban"
                >
                  {{ $t("t-agent-list-kanban") }}
                </router-link>
              </li>
              <li class="nav-item" v-if="viewPermission('APPROVAL')">
                <router-link
                    :to="{name: 'agentsApproval'}"
                    class="nav-link"
                    data-key="t-agent-approve">
                  {{ $t("t-agent-approve") }}
                </router-link>
              </li>
              <li class="nav-item">
                <router-link
                    :to="{name: 'agentPayments'}"
                    class="nav-link"
                    data-key="t-agent-payments">
                  {{ $t("t-agent-payments") }}
                </router-link>
              </li>
            </ul>
        ...
        <li class="menu-title" v-if="viewPermission('PROSPECTLIST')">
          <i class="ri-more-fill"></i>
          <span data-key="t-prospects">{{ $t("t-prospects") }}</span>
        </li>

        <li class="nav-item" v-if="viewPermission('PROSPECTLIST')">
          <a
              class="nav-link menu-link"
              href="#sidebarProspect"
              data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
              aria-controls="sidebarAuth"
          >
            <UsersIcon></UsersIcon>
            <span data-key="t-prospects">{{
                $t("t-prospects")
              }}</span>
          </a>
          <div class="collapse menu-dropdown" id="sidebarProspect">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <router-link
                    to="/prospects/ListCard"
                    class="nav-link"
                    data-key="t-clients-list"
                >
                  {{ $t("t-prospects-list-kanban") }}
                </router-link>
              </li>

              <li class="nav-item">
                <router-link
                    to="/deleted/prospects/List"
                    class="nav-link"
                    data-key="t-prospects-deleted"
                >
                  {{ $t("t-prospects-deleted") }}
                </router-link>
              </li>
            </ul>
          </div>
        ...
        <li class="menu-title" v-if="viewPermission('DEPARTMENTLIST')">
          <i class="ri-more-fill"></i>
          <span data-key="t-departments">{{ $t("t-department") }}</span>
        </li>

        <li class="nav-item" v-if="viewPermission('DEPARTMENTLIST')">
          <a
              class="nav-link menu-link"
              href="#sidebarDepartments"
              data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
              aria-controls="sidebarAuth"
          ...
          <div class="collapse menu-dropdown" id="sidebarDepartments">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item" v-if="viewPermission('UPLOADLISTS')">
                <router-link
                    to="/uploadList"
                    class="nav-link"
                    data-key="t-upload-lists">
                  {{ $t("t-upload-lists") }}
                </router-link>
              </li>
            </ul>
        ...
        <li class="menu-title" v-if="viewPermission('REPORTS')">
          <i class="ri-more-fill"></i>
          <span data-key="t-prospects">{{ $t("t-reports") }}</span>
        </li>
        <li class="nav-item" v-if="viewPermission('REPORTS')">
          <a
              class="nav-link menu-link"
              href="#sidebarReports"
              data-bs-toggle="collapse"
        ...
        <li class="menu-title" v-if="viewPermission('BOOTCAMP')">
          <i class="ri-more-fill"></i>
          <span data-key="t-bootcamp">{{ $t("t-bootcamp") }}</span>
        </li>
        <li class="nav-item" v-if="viewPermission('BOOTCAMP')">
          <a
              class="nav-link menu-link"
              href="#sidebarBootcamp"
              data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
              aria-controls="sidebarBootcamp"
          >
            <UsersIcon></UsersIcon>
            <span data-key="t-bootcamp">{{
                $t("t-bootcamp")
              }}</span>
          </a>
          <div class="collapse menu-dropdown" id="sidebarBootcamp">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <router-link
                    to="/calendar"
                    class="nav-link"
                    data-key="t-bootcamp-list">
                  {{ $t("t-bootcamp-list") }}
                </router-link>
              </li>
            </ul>
        ...
        <li class="menu-title" v-if="viewPermission('INTERVIEWS')">
          <i class="ri-more-fill"></i>
          <span data-key="t-interviews">{{ $t("t-interviews") }}</span>
        </li>
        <li class="nav-item" v-if="viewPermission('INTERVIEWS')">
          <a
              class="nav-link menu-link"
              href="#sidebarInterviews"
              data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
          ...
          >
            <UsersIcon></UsersIcon>
            <span data-key="t-interviews">{{
                $t("t-interviews")
              }}</span>
          </a>
          <div class="collapse menu-dropdown" id="sidebarInterviews">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <router-link
                    to="/calendar"
                    class="nav-link"
                    data-key="t-interview-list">
                  {{ $t("t-interview-list") }}
                </router-link>
              </li>
            </ul>
        ...
        <li class="menu-title" v-if="viewPermission('COMMUNICATIONS')">
          <i class="ri-more-fill"></i>
          <span data-key="t-communication">{{ $t("t-communication") }}</span>
        </li>
        <li class="nav-item" v-if="viewPermission('COMMUNICATIONS')">
          <a
              class="nav-link menu-link"
              href="#sidebarComm"
              data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
              aria-controls="sidebarComm"
          >
            <WifiIcon></WifiIcon>
            <span data-key="t-communication">{{
                $t("t-communication")
              }}</span>
          </a>
        ...
        <li class="nav-item">
          <a class="nav-link menu-link" target="_blank" href="https://www.university.dmbgroup.online">
            <CodepenIcon></CodepenIcon>
            <span data-key="t-agent-portal">{{ $t("t-agent-portal") }}</span>
          </a>
        </li>

        <!-- end portal agent Menu -->

        <li class="menu-title">
          <i class="ri-more-fill"></i>
          <span data-key="t-terms-conditions">{{ $t("t-terms-conditions") }}</span>
        </li>
        ...
        <li class="nav-item">
          ...
          >
          <InfoIcon></InfoIcon>
          <span data-key="t-terms-page">{{ $t("t-terms-page") }}</span>
          <span class="badge badge-pill bg-success" data-key="t-new">
            {{$t("t-new")}}
          </span>
          </router-link>
